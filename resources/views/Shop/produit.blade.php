    ...
    <div class="album py-5 bg-light">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        <img src="{{ asset('produits/happy.jpg')}}" class="card-img-top img-fluid" alt="Responsive image">
                ...
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        <img src="{{ asset('produits/startrek.jpg')}}" class="card-img-top img-fluid" alt="Responsive image">
